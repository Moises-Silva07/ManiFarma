...
class PedidoServiceTest {
    ...
    void deveAlterarStatusDoPedido() {
        ...
        // Act
        pedidoService.alterarStatus(1L, "PAGO");
    ...
    void deveAceitarStatusEmMinuscula() {
        ...
        // Act
        assertDoesNotThrow(() -> pedidoService.alterarStatus(1L, "pago"));
    ...
    void deveLancarExcecaoAoAlterarParaStatusInvalido() {
        ...
        // Act & Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            pedidoService.alterarStatus(1L, "STATUS_INVALIDO");
        });
    ...
    void deveLancarExcecaoAoAlterarStatusDePedidoInexistente() {
        ...
        // Act & Assert
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> {
            pedidoService.alterarStatus(99L, "PAGO");
        });
